...
gulp.task('init', function(cb){
    exec('git remote add origin https://' + promptInput.username + ':' + promptInput.password + '@github.com/' + promptInput.username + '/test.git', function(err, stdout, stderr){
        console.log(stdout);
        console.log(stderr);
        cb(err);
    });
...
gulp.task('test', ['fill-data'], function(cb){
    exec('git remote rm origin && git remote add origin https://' + promptInput.username + ':' + promptInput.password + '@github.com/' + promptInput.username + '/test.git && git push origin --delete test && git checkout -b test && git push origin test', function(err, stdout, stderr){
        console.log(stdout);
        console.log(stderr);
        cb(err);
    });
...
gulp.task('release', ['fill-data'], function(cb){
    exec('git remote rm origin && git remote add origin https://' + promptInput.username + ':' + promptInput.password + '@github.com/' + promptInput.username + '/test.git && git push origin --delete release && git checkout -b release && git push origin release', function(err, stdout, stderr){
        console.log(stdout);
        console.log(stderr);
        cb(err);
    });
